...
function newPicture(curPage){
  var a = curPage*3;
  var str = '';
  if (curPage == totalPage) {
    for(var i=a-3; i < todayPhoto.length; i++){
        str += '<img src="'+todayPhoto[i].img+'" width="100" height="100" padding> ';
    }
  }
  else {
    for(var i=a-3; i < a; i++){
